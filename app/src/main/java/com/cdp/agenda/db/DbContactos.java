...
public class DbContactos extends DbHelper {
    ...
    public boolean editarContacto(int id, String titulo, String direccion, String descripcion) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET titulo = '" + titulo + "', direccion = '" + direccion + "', descripcion = '" + descripcion + "' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
